...
keptn add-resource --project=keptn05eks --service=simplenode --stage=staging --resource=service-objectives.yaml --resourceUri=service-objectives.yaml
...
keptn add-resource --project=keptn05eks --service=simplenode --stage=prod --resource=service-objectives.yaml --resourceUri=service-objectives.yaml